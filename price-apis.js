...
var settings = JSON.parse(localStorage.getItem('MULTI_SETTING_APP') || '{}');
...
async function checkAllCEXWalletsPerChain() {
   ...
   // console.log("🔧 Menyisipkan info wallet ke setiap token di MULTI_SELECT_TOKENS...");

    const tokenMulti = JSON.parse(localStorage.getItem("MULTI_SELECT_TOKENS") || "[]");
    ...
    try {
        localStorage.setItem("MULTI_SELECT_TOKENS", JSON.stringify(tokenMultiUpdated));
        console.log("✅ MULTI_SELECT_TOKENS updated:", tokenMultiUpdated);
        ...
        $('#loadingOverlay').fadeOut(200);
        console.error("❌ Gagal menyimpan MULTI_SELECT_TOKENS:", e);
        alert("❌ Gagal menyimpan MULTI_SELECT_TOKENS: " + e.message);
    }
}
